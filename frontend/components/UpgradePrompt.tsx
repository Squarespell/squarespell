...
const UPGRADE_PLANS: Record<string,{id:string;name:string;price:number}[]> = { trial:[{id:'starter',name:'Starter',price:9},{id:'pro',name:'Pro',price:19},{id:'business',name:'Business',price:39}], starter:[{id:'pro',name:'Pro',price:19},{id:'business',name:'Business',price:39}], pro:[{id:'business',name:'Business',price:39}], business:[] };
