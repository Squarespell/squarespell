...
export const PLANS: Plan[] = [
  {
    ...
    excluded: [
      'A/B testing',
      'Email sequences',
      'Integrations (Mailchimp, Klaviyo, ConvertKit, Google Sheets, webhooks; Zapier planned)',
      'Advanced analytics',
      'Custom CSS',
      'White-label (custom domain planned)',
      'Team seats',
    ],
  ...
  },
  {
    ...
    included: [
      ...
      'A/B testing',
      'Email sequences',
      'Integrations with Mailchimp, Klaviyo, ConvertKit, Google Sheets and webhooks (Zapier and HubSpot planned)',
      'Webhooks',
      'Advanced analytics',
    ...
    excluded: [
      ...
      'Custom domain for quizzes (planned)',
      'Team seats',
      'API access (planned)',
  ...
  },
  {
    key: 'business',
    name: 'Business',
    desc: 'Unlimited everything with white-label and team seats. Custom domains and API access are planned.',
    monthly: 35,
    yearly: 29,
    yearlyTotal: 348,
    yearlySave: 72,
