    ...
    <div style={{ minHeight: '100vh', background: '#07090c', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: '"DM Sans", system-ui, sans-serif', padding: '40px 24px' }}>
      <div style={{ width: '100%', maxWidth: '480px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', marginBottom: '24px' }}>
          <button onClick={handleGoogle} disabled={googleLoading} style={{ flex:1, height:'44px', background: googleLoading ? 'rgba(255,255,255,0.04)' : 'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.12)', borderRadius:'10px', color:'#f0f2f5', fontSize:'14px', fontWeight:500, fontFamily:'"DM Sans",system-ui,sans-serif', cursor: googleLoading ? 'not-allowed' : 'pointer', display:'flex', alignItems:'center', justifyContent:'center', gap:'10px', transition:'all 0.15s' }}>
          ...
          <button onClick={handleApple} disabled={appleLoading} style={{ flex:1, height:'44px', background: appleLoading ? 'rgba(255,255,255,0.04)' : 'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.12)', borderRadius:'10px', color:'#f0f2f5', fontSize:'14px', fontWeight:500, fontFamily:'"DM Sans",system-ui,sans-serif', cursor: appleLoading ? 'not-allowed' : 'pointer', display:'flex', alignItems:'center', justifyContent:'center', gap:'10px', transition:'all 0.15s' }}>
