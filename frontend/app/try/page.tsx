  ...
  return (
    <div style={{ minHeight: '100vh', background: BG, fontFamily: '"DM Sans",system-ui,sans-serif', color: '#f0f2f5' }}>
      ...
      <main style={{ maxWidth: '640px', margin: '0 auto', padding: '80px 24px 60px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '15px', color: 'rgba(240,242,245,0.5)', lineHeight: 1.6, marginBottom: '24px', maxWidth: '480px', marginLeft: 'auto', marginRight: 'auto' }}>
        ...
        {stage === 'input' && (
          <div>
            <input
              ...
              style={{ width: '100%', height: '36px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '8px', color: '#f0f2f5', fontSize: '15px', padding: '0 20px', outline: 'none', fontFamily: 'inherit', boxSizing: 'border-box', marginBottom: '12px' }}
            />
            ...
            <button
              ...
              style={{ width: '100%', height: '36px', background: url.trim() ? ACC : 'rgba(210,255,29,0.3)', color: BG, fontSize: '14px', fontWeight: 600, border: 'none', borderRadius: '8px', cursor: url.trim() ? 'pointer' : 'default', fontFamily: 'inherit', transition: 'background 0.15s' }}
            >
              Build my quiz →
            </button>
        ...
        {stage === 'preview' && (
          <div style={{ animation: 'fadeIn .5s ease', textAlign: 'left' }}>
            ...
            {/* Success bar */}
            <div style={{ background: 'rgba(74,222,128,0.08)', border: '1px solid rgba(74,222,128,0.2)', borderRadius: '8px', padding: '16px 20px', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              <Link href="/sign-up?from=try" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', height: '36px', background: ACC, color: BG, fontSize: '14px', fontWeight: 600, borderRadius: '8px', textDecoration: 'none' }}>
                Publish my quiz →
              </Link>
              <Link href="/pricing" style={{ flex: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', height: '36px', padding: '0 24px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', color: '#f0f2f5', fontSize: '15px', fontWeight: 500, borderRadius: '8px', textDecoration: 'none', whiteSpace: 'nowrap' }}>
                See pricing
              </Link>
            </div>
          </div>
