          ...
          <>
            ...
            {fromTry && (
              <div style={{ marginBottom: '20px', background: 'rgba(13,115,119,0.06)', border: '1px solid rgba(13,115,119,0.15)', borderRadius: '12px', padding: '14px 18px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0D7377" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                <span style={{ fontSize: '14px', color: '#0D7377', fontWeight: 600 }}>Your quiz is ready  -  sign up to publish it</span>
              </div>
            )}
            ...
            <button onClick={handleGoogle} disabled={googleLoading} style={{
              ...
              {googleLoading ? (
                <><div style={{ width: '18px', height: '18px', border: '2px solid #E4E3E0', borderTop: '2px solid #0D7377', borderRadius: '50%', animation: 'spin 0.7s linear infinite' }}/>Connecting...</>
              ) : (
