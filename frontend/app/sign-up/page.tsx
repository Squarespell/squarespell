        ...
        {step === 'form' ? (
          <>
            <div style={{ textAlign: 'center', marginBottom: '40px' }}>
              <h1 style={{ fontSize: '36px', fontWeight: 800, color: '#f0f2f5', letterSpacing: '-0.04em', margin: '0 0 10px', lineHeight: 1.1 }}>Start your free trial</h1>
              <p style={{ fontSize: '18px', color: 'rgba(240,242,245,0.45)', margin: 0 }}>7 days free. No credit card required.</p>
            </div>
            ...
            <div style={{ display: 'flex', gap: '12px', marginBottom: '24px' }}>
              <button onClick={handleGoogleSignUp} style={socialBtnStyle}>
              ...
              <button onClick={handleAppleSignUp} style={socialBtnStyle}>
          ...
          <>
            <div style={{ textAlign: 'center', marginBottom: '40px' }}>
              ...
              <h1 style={{ fontSize: '30px', fontWeight: 800, color: '#f0f2f5', letterSpacing: '-0.04em', margin: '0 0 10px' }}>Check your email</h1>
