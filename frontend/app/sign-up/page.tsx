  ...
  <div style={{ flex: 1, background: 'linear-gradient(135deg, #0a0f05 0%, #0d1a0a 40%, #071a12 100%)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '48px', position: 'relative', overflow: 'hidden' }}>
    ...
    <div style={{ position: 'relative', zIndex: 1 }}>
      ...
      <div style={{ display: 'flex', gap: '32px', marginTop: '48px' }}>
        <div><p style={{ fontSize: '32px', fontWeight: 800, color: '#D2FF1D', letterSpacing: '-0.04em', lineHeight: 1 }}>2,400+</p><p style={{ fontSize: '14px', color: 'rgba(240,242,245,0.4)', marginTop: '4px' }}>Squarespace owners</p></div>
        <div><p style={{ fontSize: '32px', fontWeight: 800, color: '#D2FF1D', letterSpacing: '-0.04em', lineHeight: 1 }}>12%</p><p style={{ fontSize: '14px', color: 'rgba(240,242,245,0.4)', marginTop: '4px' }}>Avg conversion rate</p></div>
        <div><p style={{ fontSize: '32px', fontWeight: 800, color: '#D2FF1D', letterSpacing: '-0.04em', lineHeight: 1 }}>30s</p><p style={{ fontSize: '14px', color: 'rgba(240,242,245,0.4)', marginTop: '4px' }}>To build a quiz</p></div>
      </div>
    </div>
    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: '"DM Sans", system-ui, sans-serif', background: '#07090c' }}>
      ...
      <div style={{ width: '520px', flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px', background: '#07090c', borderLeft: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ width: '100%', maxWidth: '400px' }}>
          <h2 style={{ fontSize: '28px', fontWeight: 800, color: '#f0f2f5', letterSpacing: '-0.03em', marginBottom: '8px' }}>Start your free trial</h2>
