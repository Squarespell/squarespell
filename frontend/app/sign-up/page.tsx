      ...
      <div style={{ width: '100%', maxWidth: '480px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h1 style={{ fontSize: '36px', fontWeight: 800, color: '#f0f2f5', letterSpacing: '-0.04em', margin: '0 0 10px', lineHeight: 1.1 }}>
            {verifying ? 'Check your email' : 'Start your free trial'}
          </h1>
          <p style={{ fontSize: '18px', color: 'rgba(240,242,245,0.45)', margin: 0 }}>
            {verifying ? `We sent a code to ${email}` : '7 days free. No credit card required.'}
          </p>
        </div>
        ...
        {verifying ? (
          ...
          <form onSubmit={handleVerify}>
            <div style={{ marginBottom: '24px' }}>
              ...
              <input type="text" placeholder="Enter the 6-digit code" value={code} onChange={e => setCode(e.target.value)} style={{ ...inputStyle, textAlign: 'center', letterSpacing: '0.2em', fontSize: '22px' }} required />
            </div>
