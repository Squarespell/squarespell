...
function Sparkline({ color }: { color: string }) {
  return (
    <svg width="80" height="32" viewBox="0 0 80 32" fill="none" style={{ position: 'absolute', bottom: 8, right: 12, opacity: 0.35 }}>
      <path d={'M0 28 Q10 20 20 24 T40 16 T60 20 T80 10'} stroke={color} strokeWidth="2" fill="none" strokeLinecap="round" />
    </svg>
  );
}
    ...
    <DashboardShell title="Automations">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
            <div style={{
              ...
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={C.ACCENT} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="3" width="18" height="18" rx="2" /><path d="M9 3v18" /><path d="M14 8l3 4-3 4" />
              </svg>
            </div>
            <div>
              <div style={{ fontSize: 13, color: C.GRAY_500, fontFamily: C.FONT, fontWeight: 500, marginBottom: 4 }}>Active automations</div>
              <div style={{ fontSize: 28, fontWeight: 700, color: C.GRAY_900, fontFamily: C.FONT, lineHeight: 1 }}>{activeCount}</div>
              <div style={{ fontSize: 12, color: C.GRAY_400, fontFamily: C.FONT, marginTop: 6 }}>
                {activeCount === 0 ? 'No active rules yet' : activeCount + ' running'}
              </div>
            </div>
          </div>
        ...
        <div className="auto-stat" style={{
          ...
          <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
            <div style={{
              ...
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#7F56D9" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                <polyline points="22,6 12,13 2,6" />
              </svg>
            </div>
            <div>
              <div style={{ fontSize: 13, color: C.GRAY_500, fontFamily: C.FONT, fontWeight: 500, marginBottom: 4 }}>Emails sent (automated)</div>
              <div style={{ fontSize: 28, fontWeight: 700, color: C.GRAY_900, fontFamily: C.FONT, lineHeight: 1 }}>{totalFired}</div>
              <div style={{ fontSize: 12, color: C.GRAY_400, fontFamily: C.FONT, marginTop: 6 }}>
                {totalFired === 0 ? 'No emails sent yet' : totalFired + ' total'}
              </div>
            </div>
          </div>
          <Sparkline color="#7F56D9" />
        </div>
        ...
        <div className="auto-stat" style={{
          ...
          <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
            ...
            <div>
              <div style={{ fontSize: 13, color: C.GRAY_500, fontFamily: C.FONT, fontWeight: 500, marginBottom: 4 }}>Leads in automation</div>
              <div style={{ fontSize: 28, fontWeight: 700, color: C.GRAY_900, fontFamily: C.FONT, lineHeight: 1 }}>0</div>
              <div style={{ fontSize: 12, color: C.GRAY_400, fontFamily: C.FONT, marginTop: 6 }}>No leads enrolled yet</div>
            </div>
          </div>
          <Sparkline color="#DC6803" />
        </div>
        ...
        <div className="auto-stat" style={{
          ...
          <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
            <div style={{
              ...
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0086C9" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" />
              </svg>
            </div>
            <div>
              <div style={{ fontSize: 13, color: C.GRAY_500, fontFamily: C.FONT, fontWeight: 500, marginBottom: 4 }}>Time saved</div>
              <div style={{ fontSize: 28, fontWeight: 700, color: C.GRAY_900, fontFamily: C.FONT, lineHeight: 1 }}>0h</div>
              <div style={{ fontSize: 12, color: C.GRAY_400, fontFamily: C.FONT, marginTop: 6 }}>Automate and save time</div>
            </div>
          </div>
          <Sparkline color="#0086C9" />
        </div>
      </div>
      ...
      {rules.length === 0 ? (
        <>
          ...
          <div style={{
            background: '#fff', border: '1px solid ' + C.GRAY_200,
            borderRadius: 16, padding: '48px 20px 40px',
            display: 'flex', flexDirection: 'column', alignItems: 'center',
            marginBottom: 20,
          }}>
            {/* Workflow nodes illustration */}
            <div style={{ position: 'relative', width: 320, height: 140, marginBottom: 24 }}>
            ...
            <p style={{ fontSize: 14, color: C.GRAY_500, fontFamily: C.FONT, margin: '0 0 24px', textAlign: 'center', maxWidth: 440, lineHeight: 1.5 }}>
            ...
            <div style={{ display: 'flex', gap: 32, justifyContent: 'center', flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#12B76A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                  <polyline points="22,6 12,13 2,6" />
                </svg>
                <span style={{ fontSize: 13, color: C.GRAY_600, fontFamily: C.FONT, fontWeight: 500 }}>Send personalized emails</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontSize: 13, color: C.GRAY_600, fontFamily: C.FONT, fontWeight: 500 }}>Add tags automatically</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#7F56D9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
                </svg>
                <span style={{ fontSize: 13, color: C.GRAY_600, fontFamily: C.FONT, fontWeight: 500 }}>Save time & grow faster</span>
              </div>
            </div>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {rules.map(function (rule) {
            return (
              <div key={rule.id} className="auto-card" style={{
                background: '#fff', border: '1px solid ' + C.GRAY_200,
                borderRadius: 14, padding: 20, transition: 'box-shadow 0.2s, border-color 0.2s',
                display: 'flex', alignItems: 'center', justifyContent: 'space-between',
              }}>
                ...
                <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
                  <button type="button" className="auto-action" onClick={function () { toggleRule(rule.id, rule.enabled); }}
                    style={{
                      padding: '7px 16px', border: '1px solid ' + C.GRAY_200,
                      borderRadius: 8, background: '#fff', color: C.GRAY_600,
                      fontSize: 13, fontWeight: 500, fontFamily: C.FONT, cursor: 'pointer',
                    }}>
          ...
          {/* Recipe banner at bottom of list too */}
          <div className="auto-recipe" style={{
            background: '#fff', border: '1px solid ' + C.GRAY_200,
      ...
      {showCreate && (
        ...
        >
          <div style={{
            ...
            <div style={{ fontSize: 18, fontWeight: 700, color: C.GRAY_900, fontFamily: C.FONT, marginBottom: 20 }}>
              Create automation
            </div>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <select value={formTrigger} onChange={function (e) { setFormTrigger(e.target.value); }}
                style={{
                  width: '100%', padding: '10px 14px', border: '1px solid ' + C.GRAY_300,
                  borderRadius: 10, fontSize: 14, fontFamily: C.FONT, color: C.GRAY_900,
                  outline: 'none', cursor: 'pointer', boxSizing: 'border-box', background: '#fff',
                }}>
