...
.gnav-name{font-size:20px;font-weight:700;color:var(--t1);letter-spacing:-.03em}
.gnav-right{display:flex;gap:8px;align-items:center;margin-left:auto}
.gn-btn{font-size:16px;font-weight:500;color:var(--t3);padding:6px 12px;border-radius:8px;cursor:pointer;border:.5px solid var(--b2);background:transparent;font-family:var(--fam);transition:all .15s}
...
.dsi{display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:8px;cursor:pointer;color:var(--t3);font-size:18px;font-weight:500;transition:all .15s;border:none;background:transparent;font-family:var(--fam);width:100%;text-align:left;position:relative;letter-spacing:-.01em}
...
.dsec{font-size:15px;font-weight:700;color:var(--t4);text-transform:uppercase;letter-spacing:.1em;padding:16px 12px 7px}
...
.h3{font-size:28px;font-weight:700;color:var(--t1);letter-spacing:-.035em}
.h4{font-size:22px;font-weight:600;color:var(--t1);letter-spacing:-.02em}
.caption{font-size:15px;color:var(--t4)}
.label{font-size:14px;font-weight:700;color:var(--acc);letter-spacing:.08em;text-transform:uppercase}
.btn-p{background:var(--acc);color:#07090c;border:none;border-radius:11px;padding:16px 28px;font-size:18px;font-weight:700;font-family:var(--fam);cursor:pointer;display:inline-flex;align-items:center;gap:7px;transition:background .15s,transform .1s;letter-spacing:-.02em}
.btn-p:hover{background:#c8f517;transform:translateY(-1px)}
.btn-s{background:var(--g1);color:var(--t1);border:.5px solid var(--b1);border-radius:11px;padding:15px 26px;font-size:18px;font-weight:500;font-family:var(--fam);cursor:pointer;display:inline-flex;align-items:center;gap:7px;transition:all .15s}
.btn-s:hover{border-color:rgba(255,255,255,.16)}
.stat-card{background:var(--g1);border:.5px solid var(--b1);border-radius:13px;padding:24px 26px;transition:all .2s}
.stat-card:hover{border-color:var(--acc-b);transform:translateY(-1px)}
.stat-v{font-size:40px;font-weight:800;color:var(--acc);letter-spacing:-.05em;line-height:1}
.stat-l{font-size:14px;font-weight:700;color:var(--t4);text-transform:uppercase;letter-spacing:.07em;margin-top:4px}
.stat-d{font-size:15px;font-weight:600;margin-top:4px;color:var(--green)}
...
.ai-box{background:var(--acc-dim);border:.5px solid var(--acc-b);border-radius:10px;padding:11px 13px;font-size:16px;color:var(--t2);line-height:1.55}
.roi-card{background:linear-gradient(135deg,rgba(210,255,29,.06),rgba(210,255,29,.02));border:.5px solid var(--acc-b);border-radius:13px;padding:24px 26px}
...
.d-table th{font-size:14px;font-weight:700;color:var(--t4);text-transform:uppercase;letter-spacing:.07em;padding:9px 12px;text-align:left;border-bottom:.5px solid var(--b2)}
.d-table td{font-size:16px;color:var(--t2);padding:10px 12px;border-bottom:.5px solid var(--b3)}
.d-table tr:last-child td{border-bottom:none}
.d-table tr:hover td{background:var(--g3);cursor:pointer}
.badge-hot{display:inline-flex;align-items:center;gap:3px;background:rgba(248,113,113,.12);border:.5px solid rgba(248,113,113,.25);border-radius:20px;padding:2px 8px;font-size:14px;font-weight:700;color:#fca5a5}
.badge-warm{display:inline-flex;align-items:center;gap:3px;background:rgba(251,191,36,.1);border:.5px solid rgba(251,191,36,.2);border-radius:20px;padding:2px 8px;font-size:14px;font-weight:700;color:#fcd34d}
.badge-cold{display:inline-flex;align-items:center;gap:3px;background:rgba(96,165,250,.1);border:.5px solid rgba(96,165,250,.2);border-radius:20px;padding:2px 8px;font-size:14px;font-weight:700;color:#93c5fd}
.pipe-stage{border-radius:9px;padding:4px 10px;font-size:15px;font-weight:600;display:inline-flex;align-items:center;gap:4px}
...
<div class="dcontent">
  <div class="trial-bar">
    <div style="display:flex;align-items:center;gap:12px">
      ...
      <div><p style="font-size:17px;font-weight:700;color:var(--t1);margin-bottom:2px">5 days left on your free trial</p><p style="font-size:15px;color:var(--t3)">Upgrade before trial ends to keep your leads and quizzes.</p></div>
    </div>
    <div style="display:flex;gap:9px;flex-shrink:0">
      <button class="btn-p" style="font-size:16px;padding:13px 22px" onclick="window.__goTo('/pricing')">Upgrade now</button>
      <button style="font-size:16px;color:var(--t4);background:transparent;border:none;cursor:pointer;font-family:var(--fam)">Remind me later</button>
    </div>
  </div>
  ...
  <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px">
    ...
    <div style="display:flex;gap:9px">
      <button class="btn-s" style="font-size:16px;padding:13px 20px" onclick="window.__goTo('/dashboard/new')"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg> New quiz</button>
      <button class="btn-s" style="font-size:16px;padding:13px 20px">Export CSV</button>
    </div>
  </div>
  ...
  <div style="display:grid;grid-template-columns:1.5fr 1fr;gap:18px;margin-bottom:18px">
    <div class="glass-sm" style="padding:26px">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px"><p class="h4">Daily performance</p><div style="display:flex;gap:10px"><div style="display:flex;align-items:center;gap:4px"><div class="cdot" style="background:var(--acc)"></div><span style="font-size:14px;color:var(--t3)">Views</span></div><div style="display:flex;align-items:center;gap:4px"><div class="cdot" style="background:var(--green)"></div><span style="font-size:14px;color:var(--t3)">Leads</span></div></div></div>
      ...
      <div style="display:flex;gap:5px"><span style="flex:1;text-align:center;font-size:14px;color:var(--t4)">Mon</span><span style="flex:1;text-align:center;font-size:14px;color:var(--t4)">Tue</span><span style="flex:1;text-align:center;font-size:14px;color:var(--t4)">Wed</span><span style="flex:1;text-align:center;font-size:14px;color:var(--t4)">Thu</span><span style="flex:1;text-align:center;font-size:14px;color:var(--t4)">Fri</span><span style="flex:1;text-align:center;font-size:14px;color:var(--acc);font-weight:700">Sat</span><span style="flex:1;text-align:center;font-size:14px;color:var(--t4)">Sun</span></div>
    </div>
    <div class="glass-sm" style="padding:26px">
      <p class="h4" style="margin-bottom:14px">Traffic sources</p>
      <div style="display:flex;flex-direction:column;gap:10px">
        <div><div style="display:flex;justify-content:space-between;margin-bottom:4px"><span style="font-size:16px;color:var(--t2);font-weight:500">Direct</span><span style="font-size:16px;color:var(--t3)">58%</span></div><div class="usage-wrap"><div class="usage-bar" style="width:58%;background:var(--acc)"></div></div></div>
        <div><div style="display:flex;justify-content:space-between;margin-bottom:4px"><span style="font-size:16px;color:var(--t2);font-weight:500">Instagram</span><span style="font-size:16px;color:var(--t3)">24%</span></div><div class="usage-wrap"><div class="usage-bar" style="width:24%;background:rgba(210,255,29,.6)"></div></div></div>
        <div><div style="display:flex;justify-content:space-between;margin-bottom:4px"><span style="font-size:16px;color:var(--t2);font-weight:500">Google</span><span style="font-size:16px;color:var(--t3)">12%</span></div><div class="usage-wrap"><div class="usage-bar" style="width:12%;background:rgba(210,255,29,.35)"></div></div></div>
        <div><div style="display:flex;justify-content:space-between;margin-bottom:4px"><span style="font-size:16px;color:var(--t2);font-weight:500">Pinterest</span><span style="font-size:16px;color:var(--t3)">6%</span></div><div class="usage-wrap"><div class="usage-bar" style="width:6%;background:rgba(210,255,29,.2)"></div></div></div>
      </div>
    </div>
  </div>
  ...
  <div style="display:grid;grid-template-columns:1fr 1.4fr;gap:18px;margin-bottom:18px">
    <div class="glass-sm" style="padding:26px">
      ...
      <div style="display:flex;flex-direction:column;gap:7px">
        <div class="funnel-step"><span style="font-size:15px;color:var(--t3);width:55px;flex-shrink:0;font-weight:500">Q1</span><div class="f-bar-wrap"><div class="f-bar" style="width:100%"></div></div><span style="font-size:16px;color:var(--t1);font-weight:700;width:36px;text-align:right">100%</span></div>
        <div class="funnel-step"><span style="font-size:15px;color:var(--t3);width:55px;flex-shrink:0;font-weight:500">Q2</span><div class="f-bar-wrap"><div class="f-bar" style="width:88%"></div></div><span style="font-size:16px;color:var(--t1);font-weight:700;width:36px;text-align:right">88%</span></div>
        <div class="funnel-step"><span style="font-size:15px;color:var(--yellow);width:55px;flex-shrink:0;font-weight:600">Q3 ⚠</span><div class="f-bar-wrap"><div class="f-bar" style="width:72%;background:var(--yellow)"></div></div><span style="font-size:16px;color:var(--yellow);font-weight:700;width:36px;text-align:right">72%</span></div>
        <div class="funnel-step"><span style="font-size:15px;color:var(--t3);width:55px;flex-shrink:0;font-weight:500">Q4</span><div class="f-bar-wrap"><div class="f-bar" style="width:68%;background:rgba(210,255,29,.35)"></div></div><span style="font-size:16px;color:var(--t1);font-weight:700;width:36px;text-align:right">68%</span></div>
        <div class="funnel-step"><span style="font-size:15px;color:var(--t3);width:55px;flex-shrink:0;font-weight:500">Lead</span><div class="f-bar-wrap"><div class="f-bar" style="width:61%;background:var(--green)"></div></div><span style="font-size:16px;color:var(--green);font-weight:700;width:36px;text-align:right">61%</span></div>
      </div>
      <div class="ai-box" style="margin-top:12px">💡 Q3 drop is 16 pts. Try reducing to 3 options to improve completion by ~12%.</div>
    </div>
    <div class="glass-sm" style="padding:26px">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px"><p class="h4">Recent leads</p><button style="font-size:15px;color:var(--acc);background:transparent;border:none;cursor:pointer;font-family:var(--fam);font-weight:600" onclick="window.__goTo('/dashboard/leads')">View all →</button></div>
      <table class="d-table">
  ...
  <div class="roi-card" style="margin-bottom:14px;display:flex;align-items:center;justify-content:space-between">
    ...
    <div style="text-align:right"><p style="font-size:52px;font-weight:800;color:var(--acc);letter-spacing:-.06em">$5,700</p><p style="font-size:15px;color:var(--t3)">Potential revenue</p></div>
  </div>
  ...
  <div style="background:var(--g1);border:.5px solid var(--b1);border-radius:13px;padding:14px 18px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px">
    <div><div style="display:flex;justify-content:space-between;margin-bottom:4px"><span style="font-size:15px;color:var(--t2);font-weight:500">Leads used (trial)</span><span style="font-size:15px;color:var(--yellow)">38/50 — Running low</span></div><div class="usage-wrap" style="width:200px"><div class="usage-bar" style="width:76%;background:var(--yellow)"></div></div></div>
    <button class="btn-p" style="font-size:16px;padding:13px 22px" onclick="window.__goTo('/pricing')">Upgrade to Pro</button>
  </div>
</div>
</body></html>`;
