...
export const EMAIL_TEMPLATES: EmailTemplate[] = [
  {
    ...
    html: shell(`
      ...
      <a href="{{ctaUrl}}" style="display:inline-block;background:#111;color:#fff;padding:12px 20px;border-radius:10px;text-decoration:none;font-weight:600;">See your plan</a>
    `),
  },
  {
    id: 'welcome',
    ...
    html: shell(`
      ...
      <a href="{{ctaUrl}}" style="display:inline-block;background:#111;color:#fff;padding:12px 20px;border-radius:10px;text-decoration:none;font-weight:600;">Get started</a>
    `),
  },
  {
    id: 'nurture',
    ...
    html: shell(`
      ...
      <a href="{{ctaUrl}}" style="color:#0a0a0a;font-weight:600;text-decoration:underline;">Read it here →</a>
    `),
  },
  {
    id: 'promo',
