...
function iconBg(type: string): string {
  if (type === 'broadcast') return C.ACCENT;
  if (type === 'automation') return '#7F56D9';
  if (type === 'quiz-result') return C.ACCENT;
  return '#DC6803';
}
...
function openRate(c: Campaign): string {
  ...
  if (sent === 0) return '0%';
  /* we don't have opened_count on Campaign type, compute from stats if available */
  ...
  return (
    <DashboardShell title="Email Campaigns">
      <style>{`
        ...
        .ec-page-btn:hover { background: ${C.GRAY_50} !important; }
      `}</style>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 24, flexWrap: 'wrap', gap: 16 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
          ...
          {/* Filter tabs */}
          <div style={{ display: 'flex', background: C.GRAY_50, borderRadius: 10, padding: 3, border: '1px solid ' + C.GRAY_200 }}>
      ...
      {err && (
        <div style={{
          ...
          {err}
          <button onClick={function () { setErr(null); }} style={{ background: 'none', border: 'none', color: C.DANGER, cursor: 'pointer', fontSize: 16 }}>&times;</button>
        </div>
      )}

      {/* ─── Stats row ─── */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1.2fr', gap: 16, marginBottom: 24 }}>
        {/* Emails Sent */}
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 13, color: C.GRAY_500, fontFamily: C.FONT, fontWeight: 500, marginBottom: 4 }}>Emails Sent</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 13, color: C.GRAY_500, fontFamily: C.FONT, fontWeight: 500, marginBottom: 4 }}>Average Open Rate</div>
            <div style={{ fontSize: 26, fontWeight: 700, color: C.GRAY_900, fontFamily: C.FONT, lineHeight: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 13, color: C.GRAY_500, fontFamily: C.FONT, fontWeight: 500, marginBottom: 6 }}>
            Monthly Email Usage
          </div>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginBottom: 8 }}>
            <span style={{ fontSize: 28, fontWeight: 700, color: C.GRAY_900, fontFamily: C.FONT }}>
              {quota ? quota.used.toLocaleString() : '0'}
            </span>
            <span style={{ fontSize: 14, color: C.GRAY_500, fontFamily: C.FONT }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 600, color: C.GRAY_700, fontFamily: C.FONT, minWidth: 36 }}>
              {pct}%
            </span>
          </div>
          {/* Upsell */}
          <div style={{
            ...
            padding: 14, background: C.GRAY_50, borderRadius: 10,
          }}>
            <div style={{
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 13, fontWeight: 600, color: C.GRAY_900, fontFamily: C.FONT, marginBottom: 2 }}>
                You're reaching more leads!
              </div>
              <div style={{ fontSize: 12, color: C.GRAY_500, fontFamily: C.FONT, lineHeight: 1.4 }}>
                Upgrade your plan to unlock more emails and advanced automation.
              </div>
        ...
        <>
                ...
                >
                      ...
                      <div style={{ position: 'relative' }} ref={menuOpen === c.id ? menuRef : undefined}>
                        <button
                          ...
                          style={{
                            ...
                            color: C.GRAY_400, cursor: 'pointer',
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                          }}
                        >
                        ...
                        {menuOpen === c.id && (
                          <div style={{
                            ...
                            background: '#fff', border: '1px solid ' + C.GRAY_200,
                            borderRadius: 10, boxShadow: C.SHADOW_LG,
                  ...
                  <div style={{ padding: '14px 20px 0', flex: 1 }}>
                    <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
                      ...
                      <div style={{
                        width: 44, height: 44, borderRadius: 12,
                        background: iconBg(type), display: 'flex',
                        alignItems: 'center', justifyContent: 'center', flexShrink: 0,
                      }}>
                  ...
                  <div style={{
                    ...
                    borderTop: '1px solid ' + C.GRAY_100, marginTop: 14,
                  }}>
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 6 }}>
                      ...
                      <div>
                        <div style={{ fontSize: 14, fontWeight: 700, color: C.GRAY_900, fontFamily: C.FONT }}>{sent.toLocaleString()}</div>
                        <div style={{ fontSize: 11, color: C.GRAY_400, fontFamily: C.FONT }}>Sent</div>
                      </div>
                    </div>
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 6 }}>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#12B76A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" />
                      </svg>
                      <div>
                        <div style={{ fontSize: 14, fontWeight: 700, color: C.GRAY_900, fontFamily: C.FONT }}>{opened.toLocaleString()}</div>
                        <div style={{ fontSize: 11, color: C.GRAY_400, fontFamily: C.FONT }}>Opened</div>
                      </div>
                    </div>
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 6 }}>
                      ...
                      <div>
                        <div style={{ fontSize: 14, fontWeight: 700, color: C.GRAY_900, fontFamily: C.FONT }}>{rate}</div>
                        <div style={{ fontSize: 11, color: C.GRAY_400, fontFamily: C.FONT }}>Open Rate</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{
                    ...
                    <Link href={'/dashboard/emails/' + c.id} style={{ textDecoration: 'none', flex: 1 }}>
                      <button type="button" className="ec-action" style={{
                        display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
                        padding: '12px 0', width: '100%', border: 'none',
                        background: 'transparent', color: C.GRAY_500,
                    ...
                    <div style={{ width: 1, height: 20, background: C.GRAY_100 }} />
                    <Link href={'/dashboard/emails/' + c.id} style={{ textDecoration: 'none', display: 'flex' }}>
                      <button type="button" className="ec-action" style={{
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        padding: '12px 14px', border: 'none',
                        background: 'transparent', color: C.GRAY_400,
                        cursor: 'pointer', borderRadius: '0 0 14px 0',
                      }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 13, color: C.GRAY_500, fontFamily: C.FONT }}>
              Showing {Math.min((page - 1) * perPage + 1, filtered.length)} to {Math.min(page * perPage, filtered.length)} of {filtered.length} campaigns
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
              <button
                ...
                style={{
                  ...
                  color: page <= 1 ? C.GRAY_300 : C.GRAY_500,
              ...
              <button
                ...
                style={{
                  width: 32, height: 32, borderRadius: 8,
                  border: '1px solid ' + C.GRAY_200, background: '#fff',
                  color: page >= totalPages ? C.GRAY_300 : C.GRAY_500,
