              ...
              {currentQ ? (
                ...
                <>
                  <div className="settings-hero">
                    ...
                    <div className="settings-hero-text">Quiz settings</div>
                    <div className="settings-hero-sub">Edit what visitors see before starting</div>
                  </div>

                  <div className="settings-card">
                    <label className="settings-card-label">Title</label>
                    <input
                      className="field-input"
                      value={quiz?.title || ''}
                    ...
                    />
                    <label className="settings-card-label" style={{ marginTop: 12 }}>Description</label>
                    <textarea
                      className="field-textarea"
