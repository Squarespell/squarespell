...
function DropdownMenuPortal(props: React.ComponentProps<typeof DropdownMenuPrimitive.Portal>) {
  // See useDashboardPortalContainer's doc comment -- without this, the menu
  // renders in document.body, outside .dashboard-root's scoped design tokens.
  const container = useDashboardPortalContainer();
  return <DropdownMenuPrimitive.Portal data-slot="dropdown-menu-portal" container={container} {...props} />;
}
